  ...
  <div class="container">
    ...
    <div class="b-teaser" v-for="( element, index) in article.elements">
      ...
      <div v-else class='one'>
        <img v-if="element.type==='image'" :srcset="getImgSrc(article)" sizes="(max-width:640px) 640w, (max-width: 1600px) 1600w," alt=""  :src="getImgSrc(article)[1]" alt="" class="b-teaser__img">
